...
public class InvitemeMemberuploadCSVEmployeesTest {
...
//	        Thread.sleep(2000);
	       ...
	       // Enter Email address
	        driver.findElement(By.xpath("//input[@formcontrolname='email']")).sendKeys("loyalyticst@gmail.com");
...
//				Thread.sleep(2000);
				...
				driver.findElement(By.id("email")).sendKeys("loyalyticst@gmail.com");
//				Thread.sleep(1000);
...
//		        Thread.sleep(2000);
		        ...
		        //click on Customer 
		        driver.findElement(By.xpath("//label[@nzvalue='employee']")).click();
...
//	            Thread.sleep(1000);
	            ...
	            //click on selectt privilege
	            driver.findElement(By.xpath("//div[text()='Select Privilege']")).click();
	            Thread.sleep(3000);
	            
	            // Select Privilage from dropdown
	            driver.findElement(By.xpath("(//Li[contains(@class,'ant')])[5]")).click();
	            Thread.sleep(2000);
