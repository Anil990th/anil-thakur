...
public class InviteMemberuploadCSVitemsTest {

	@Test
	public static void inviteIuploadCsv() throws InterruptedException, IOException {
...
//	        Thread.sleep(2000);
	       ...
	       // Enter Email address
	        driver.findElement(By.xpath("//input[@formcontrolname='email']")).sendKeys("item08438@gmail.com");
...
//				Thread.sleep(2000);
				...
				driver.findElement(By.id("email")).sendKeys("item08438@gmail.com");
//				Thread.sleep(1000);
...
//		        Thread.sleep(2000);
		        ...
		        //click on item
		        driver.findElement(By.xpath("//label[@nzvalue='item']")).click();
